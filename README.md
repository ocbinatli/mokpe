This repository contains R implementations of the algorithms proposed in "MOKPE: Drug–target interaction prediction via manifold optimization based kernel preserving embedding".
